...
- [一、Transformer 模型基础](#一transformer-模型基础)
  - [1. 什么是 NLP（自然语言处理）？](#1-什么是-nlp自然语言处理)
  - [2. Transformer 是什么？](#2-transformer-是什么)
  - [3. Transformer 核心组件](#3-transformer-核心组件)
  - [4. Transformer 家族](#4-transformer-家族)
- [二、NLP 任务类型与应用](#二nlp-任务类型与应用)
  - [1. 四大类 NLP 任务](#1-四大类-nlp-任务)
  - [2. 常见 NLP 任务详解](#2-常见-nlp-任务详解)
  - [3. 任务对应的模型架构](#3-任务对应的模型架构)
  - [4. 从预训练到任务适配](#4-从预训练到任务适配)
- [三、为什么要微调模型](#三为什么要微调模型)
- [四、微调的原理](#四微调的原理)
- [五、微调流程](#五微调流程)
  - [1. 数据准备](#1-数据准备)
  - [2. 数据预处理](#2-数据预处理)
  ...
  - [7. 保存模型](#7-保存模型)
- [六、微调后的效果](#六微调后的效果)
- [七、Embedding 语义向量](#七embedding-语义向量)
  - [1. 什么是 Embedding？](#1-什么是-embedding)
- [八、RAG 检索增强生成](#八rag-检索增强生成)
  - [1. 什么是 RAG？](#1-什么是-rag)
  - [2. RAG 完整流程](#2-rag-完整流程)
  - [3. Embedding 搜索 vs 关键词搜索](#3-embedding-搜索-vs-关键词搜索)
- [九、Agentic RAG（智能检索）](#九agentic-rag智能检索)
- [全文关键要点总结](#全文关键要点总结)
- [参考资源](#参考资源)
